...
class BuyCoinPageFour extends StatefulWidget {
  static const sid = 'buy_coin_page_four';

  @override
  _BuyCoinPageFourState createState() => _BuyCoinPageFourState();
}

class _BuyCoinPageFourState extends State<BuyCoinPageFour> {
  double value;
  Hour suns_f;
  Hour sune_f;
  Hour mons_f;
