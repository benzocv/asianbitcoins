...
Future<TransactionsList> fetchPost() async {
  ...
  final response = await http.get(
      'https://asianbitcoins.org/abc/api/getcancelledtrades.php?key=anu5781&email=' +
          email);
...
class DashboardCancelledTrade extends StatefulWidget {
  static const sid = 'dashboard_cancelled_trade';

  @override
  _DashboardCancelledTradeState createState() =>
      _DashboardCancelledTradeState();
}

class _DashboardCancelledTradeState extends State<DashboardCancelledTrade> {
  String value;
              ...
              Container(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: 'All Cancelled/Disputed Trades',
                        style: text2.copyWith(
                          color: color4,
                        ),
                      ),
...
//                                ),
          ...
          if (snapshot.data.transactions.length == 0) {
            list.add(
              Text(
                "You don’t have any cancelled/disputed trade.",
                textAlign: TextAlign.center,
              ),
            );
          }
...
//
  ...
  _launchURL() async {
    ...
    String email = prefs.getString('email');
    String url =
        'https://asianbitcoins.org/abc/api/cancelledtrades_transaction_uid.php?email=' +
            email;
