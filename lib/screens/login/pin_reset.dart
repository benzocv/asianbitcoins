...
class PinReset extends StatefulWidget {
  static const sid = 'pin_reset';

  @override
  _PinResetState createState() => _PinResetState();
}

class _PinResetState extends State<PinReset> {
  String value;
  String value_old_pin;
...
//
  ...
  void pin_reset(String pin,String old_pin) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
   if(prefs.getString('pin')==old_pin) {
