...
class SellCoinPageOne extends StatefulWidget {
  static const sid = 'sell_coin_page_one';

  @override
  _SellCoinPageOneState createState() => _SellCoinPageOneState();
}

class _SellCoinPageOneState extends State<SellCoinPageOne> {
  String value;
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Container(
                                width: width - 32,
                                child: Text(
                                  'You need to specify the country where you want to sell bitcoins',
                                  style: text11,
                                ),
                              ),
                            ),
                                    ...
                                    child: RichText(
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text:
                                                'See the payment method risk assessment in ',
                                            style: text11,
                                          ),
                                          TextSpan(
                                            text: 'guide.',
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            'Your advertisement will be shown to the dashboard of only those who want to buy bitcoins in this currency.',
                                        style: text11,
                                      ),
                                    ],
                                  ),
              ...
              child: GestureDetector(
                onTap: () {
                  if (_formKey2.currentState.validate()) {
                    ...
                    form.save();
                    Navigator.pushNamed(context, SellCoinPageTwo.sid,
