...
class SellCoinPageTwo extends StatefulWidget {
  static const sid = 'sell_coin_page_two';

  @override
  _SellCoinPageTwoState createState() => _SellCoinPageTwoState();
}

class _SellCoinPageTwoState extends State<SellCoinPageTwo> {
  bool bankmethod = false;
  double value;
  double margin = 1;
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (_formKey2.currentState.validate()) {
                            ...
                            form.save();
                            Navigator.pushNamed(context, SellCoinPageThree.sid,
