...
Future<Post> fetchPost2(String id) async {
  ...
  final response = await http.get(
      'https://asianbitcoins.org/abc/api/sell_trade_explore.php?id=' +
          id +
          '&key=anu5781&email=' +
          email);
...
class SellTradeExplore extends StatefulWidget {
  static const sid = 'sell_trade_explore';

  @override
  _SellTradeExploreState createState() => _SellTradeExploreState();
}

class _SellTradeExploreState extends State<SellTradeExplore> {
  String value;
  bool btcinr = true;
  double btcvalue = 0;
  double inrvalue = 0;
