...
Future<TransactionsList> fetchPost2() async {
  ...
  final response = await http.get(
      'https://asianbitcoins.org/abc/api/incoming_transactions.php?key=anu5781&email=' +
          email);
...
//  final String body;
  ...
  Post2({this.message, this.amount, this.confirmations, this.sender_address});
...
class IncomingTransactions extends StatefulWidget {
  static const sid = 'incoming_transactions';

  @override
  _IncomingTransactionsState createState() => _IncomingTransactionsState();
}

class _IncomingTransactionsState extends State<IncomingTransactions> {
  String value;
